package urf.police.lecturer_supplied.observation;
 ...
 * - record CLEAR-module result
 * - measure CLEAR calculation time
...
public class URFObservedExtActionClear extends DefaultExtActionClear {
  ...
  public URFObservedExtActionClear(AgentInfo agentInfo, WorldInfo worldInfo, 
  ...
  public ExtAction calc() {
     ...
     */
    this.metrics.recordClearModuleResult(this.agentInfo.getTime(), this.requestedTarget,
                                         action, elapsedNanos);
