 ...
 *
 * <p>Observation responsibilities: - record MOVE-module result - measure MOVE calculation time -
...
public class URFObservedExtActionMove extends DefaultExtActionMove {
  ...
  public URFObservedExtActionMove(
      AgentInfo agentInfo,
      WorldInfo worldInfo,
  ...
  public ExtAction calc() {
     ...
     */
    this.metrics.recordMoveModuleResult(
