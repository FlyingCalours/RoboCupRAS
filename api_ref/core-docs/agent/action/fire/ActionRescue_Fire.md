...
> Identical API to the ambulance version — see [ActionRescue_Ambulance.md](ActionRescue_Ambulance.md). Import the class from the package matching your agent type.
